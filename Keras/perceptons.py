# source code from https://www.datacamp.com/community/tutorials/deep-learning-python
# %%
# Import pandas
...
ax[1].hist(white.alcohol, 10, facecolor='white', ec="black",
           lw=0.5, alpha=0.5, label="White wine")
